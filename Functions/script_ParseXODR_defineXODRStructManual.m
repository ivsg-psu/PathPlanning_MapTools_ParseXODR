...
% the previous segment. fcn_ParseXODR_extractXYfromSTCurves() may be used to determine
...
initial_values = [str2double(ODRStruct.OpenDRIVE.road{1}.planView.geometry{2}.Attributes.x),...
...
St_coordinates = [str2double(ODRStruct.OpenDRIVE.road{1}.planView.geometry{2}.Attributes.s)+...
    str2double(ODRStruct.OpenDRIVE.road{1}.planView.geometry{2}.Attributes.length),...
    0];
curve_parameters = [str2double(ODRStruct.OpenDRIVE.road{1}.planView.geometry{2}.arc.Attributes.curvature) 0];

[x0,y0,h0] = fcn_ParseXODR_extractXYfromSTCurves('arc',initial_values, St_coordinates, curve_parameters);
