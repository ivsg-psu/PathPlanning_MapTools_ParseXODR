...
% OUTPUTS:
%
%      header: a structure containing the following elements with
%      default settings, such that each setting complies with ASAM
%      OPENDRIVE standard for the "header" field under the OpenDRIVE
%      structure:
%
%        header.Attributes.date 
%        header.Attributes.east 
%        header.Attributes.name 
%        header.Attributes.north
%        header.Attributes.revMajor
%        header.Attributes.revMinor
%        header.Attributes.south
%        header.Attributes.vendor
%        header.Attributes.version
%        header.Attributes.west
%     
%
% DEPENDENCIES:
%
...
% EXAMPLES:
%      
% See the script: script_test_fcn_ParseXODR_fillDefaultHeader
