%% script_test_fcn_ParseXODR_extractFromRoad_LanesSt
% Script to extract LaneGeometry in an XODR file.
% Tests function fcn_ParseXODR_extractFromRoad_LanesSt
%
...
[stationPoints,tLeft,transverseCenterOffsets,tRight] = fcn_ParseXODR_extractFromRoad_LanesSt(current_road,0.1,fig_num*100);
