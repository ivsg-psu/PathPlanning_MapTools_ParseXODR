function [xPts,yPts] = fcn_ParseXODR_extractFromRoadPlanView_STtoXY(planView_geometry, stationPoints, varargin)
...
% FORMAT:
%
%       [xPts,yPts] = fcn_ParseXODR_extractFromRoadPlanView_STtoXY(ODRRoad,stationPoints,tPts)
%
% INPUTS:
%
...
% -- renamed to fcn_ParseXODR_extractFromRoadPlanView_STtoXY
...
if flag_do_plots
    ...
    [xPts_roadReferenceLine,yPts_roadReferenceLine] = fcn_ParseXODR_extractFromRoadPlanView_STtoXY(planView_geometry, roadStationPoints);
