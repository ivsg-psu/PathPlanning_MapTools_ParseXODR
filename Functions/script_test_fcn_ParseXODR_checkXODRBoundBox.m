% script_test_fcn_ParseXODR_checkXODRBoundBox
% Script to test XODR structure compliance
% Tests function fcn_ParseXODR_checkXODRBoundBox
%
% Revision history:
...
% Check the structure
[ODRStruct, flag_warnings_were_found] = fcn_ParseXODR_checkXODRBoundBox(ODRStruct);
...
% Check the structure
[ODRStruct, flag_warnings_were_found] = fcn_ParseXODR_checkXODRBoundBox(ODRStruct, fig_num);
...
% Make sure our starter one is fixed!
...
ODRStruct_BAD.OpenDRIVE.header.Attributes.east = sprintf('%.16e',0);
...
[ODRStruct_fixed, flag_warnings_were_found] = fcn_ParseXODR_checkXODRBoundBox(ODRStruct_BAD);
...
[~, flag_warnings_were_found] = fcn_ParseXODR_checkXODRBoundBox(ODRStruct_fixed);
