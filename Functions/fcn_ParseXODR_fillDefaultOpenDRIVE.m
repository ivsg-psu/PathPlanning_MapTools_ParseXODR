function OpenDRIVE = fcn_ParseXODR_fillDefaultOpenDRIVE(varargin)
%% fcn_ParseXODR_fillDefaultOpenDRIVE
% Fills the default OpenDRIVE structure. This is usually the top-most
% structure in the XODR specification, for example:
%
%  testTrack.OpenDRIVE.(etc)
%
% FORMAT:
%
...
% OUTPUTS:
%
%      OpenDRIVE: a structure containing the following elements with
%      default settings, such that each setting complies with ASAM
%      OPENDRIVE standard:
%
%      OpenDRIVE.header - contains default header information using
%      fcn_ParseXODR_fillDefaultHeader
%      OpenDRIVE.road{1,1} - contains default road information
%     
%
% DEPENDENCIES:
%
...
% EXAMPLES:
%      
% See the script: script_test_fcn_ParseXODR_fillDefaultOpenDRIVE
...
% Create the empty OpenDRIVE structure
OpenDRIVE = struct();

OpenDRIVE.header = fcn_ParseXODR_fillDefaultHeader(flag_initialize_only_required_fields, -1);
OpenDRIVE.road   = fcn_ParseXODR_fillDefaultRoad(flag_initialize_only_required_fields, -1);
