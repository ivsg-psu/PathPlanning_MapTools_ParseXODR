...
%
%       roadNetwork =
%       fcn_ParseXODR_fillDefaultRoadNetwork({flag_initialize_only_required_fields},
%       {fig_num});
%
% INPUTS:
%
...
roadNetwork = struct();
roadNetwork.OpenDRIVE = fcn_ParseXODR_fillDefaultOpenDRIVE(flag_initialize_only_required_fields, -1);
