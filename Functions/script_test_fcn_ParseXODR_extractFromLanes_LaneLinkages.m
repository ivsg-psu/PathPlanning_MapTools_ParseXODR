%% script_test_fcn_ParseXODR_extractFromLanes_LaneLinkages
% Script to extract LaneGeometry in an XODR file.
% Tests function fcn_ParseXODR_extractFromLanes_LaneLinkages
%
...
% Check lengths - should have same rows as number of lane sections
assert(length(laneLinksLeft(:,1))==length(lanesStructure.laneSection));
assert(length(laneLinksRight(:,1))==length(lanesStructure.laneSection));

assert(length(laneLinksLeft(1,:))==3);
assert(length(laneLinksRight(1,:))==2);
...
assert(length(laneLinksLeft(1,:))==4);
assert(length(laneLinksRight(1,:))==4);
...
assert(length(laneLinksLeft(1,:))==3);
assert(length(laneLinksRight(1,:))==3);
...
assert(length(laneLinksLeft(1,:))==2);
assert(length(laneLinksRight(1,:))==2);
